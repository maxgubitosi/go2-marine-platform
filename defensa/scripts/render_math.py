...
# El desacople temporal de heave va como rho y no como kappa, que es la letra
# que usa el informe. Es la única fórmula del deck que se aparta de la notación
# del texto, y a propósito: el informe llama kappa a dos cosas sin relación, los
...
# En pitch el informe también escribe kappa_p, pero vale 1: proyectarlo solo
# carga la ecuación, así que el deck lo omite (acordado 15-08).
#
...
eq("commands", 2282,
   ...
   r"p(t) &= A_p \sin(\omega t + \pi/3) \\[4pt]"
